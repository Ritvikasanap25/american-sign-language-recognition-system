...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x = 135, y = 10, width = 640, height = 400)
        
        self.panel2 = tk.Label(self.root) # initialize image panel
        self.panel2.place(x = 460, y = 95, width = 310, height = 310)

        self.T = tk.Label(self.root)
        self.T.place(x = 300, y = 17)
        self.T.config(text = "American Sign Language System", font = ("Courier", 20, "bold"))

        self.panel3 = tk.Label(self.root) # Current Symbol
        self.panel3.place(x = 400, y = 440)
        ...
        self.panel4.place(x = 220, y = 480)

        self.T2 = tk.Label(self.root)
        self.T2.place(x = 10,y = 480)
        self.T2.config(text = "Word :", font = ("Courier", 20, "bold"))

        self.panel5 = tk.Label(self.root) # Sentence
        self.panel5.place(x = 350, y = 520)
        ...
        self.bt2.place(x = 325, y = 600)

        self.bt3 = tk.Button(self.root, command = self.action3, height = 0, width = 0)
        self.bt3.place(x = 625, y = 600)
